...
REM Ask user for installation or uninstallation
echo.
echo "1) Install (Block addresses)"
echo "2) Uninstall (Clear hosts and restore rights)"
set /p action="Select an option (1/2): "
...
if "%action%"=="1" (
    ...
    echo Hosts file has been cleared and all permissions restored.
